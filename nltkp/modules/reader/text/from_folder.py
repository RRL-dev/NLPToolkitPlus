...
class FolderTextSplitterConfig(BaseModel):
...
class FolderTextSplitter(RecursiveCharacterTextSplitter):
    """Extends RecursiveCharacterTextSplitter to handle text file splitting in a folder."""

    def __init__(self: FolderTextSplitter, config: FolderTextSplitterConfig) -> None:
        ...
        if isinstance(self.tokenizer, PreTrainedTokenizerBase):
            ...
            self._chunk_overlap = int(self._chunk_size / 10)

    def _load_tokenizer(self: FolderTextSplitter, model_name: str) -> None:
    ...
    def read_text_file(self: FolderTextSplitter, file_path: str | Path) -> str:
    ...
    def read_text_files_in_folder(self: FolderTextSplitter) -> list[Document]:
