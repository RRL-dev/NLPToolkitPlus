...
class HandlerMessage(BaseModel):
    ...
    def add_message(self: HandlerMessage, role: str, content: str) -> None:
    ...
    def get_last_user_message(self: HandlerMessage) -> str:
    ...
    def __str__(self: HandlerMessage) -> str:
